...
**Expected result: Successful login, the user is directed to the products page**

**Actual result: The user is directed to the products page**



### TC002:Login with correct username and wrong password ###
